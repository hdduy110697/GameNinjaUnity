    ...
    private void CheckIfTimeToFire()
    {
        ...
        }else if (health < 15)
        {
            if (!faceright)
            {
                ...
                {
                    GameObject bullet = (GameObject)Instantiate(bulletRef);
                    bullet.transform.position = new Vector3(transform.position.x + 0.4f, transform.position.y + .2f+(i/2f), -1);
            ...
            if (faceright)
            {
                ...
                {
                    GameObject bullet = (GameObject)Instantiate(bulletRef);
                    bullet.transform.position = new Vector3(transform.position.x + 0.4f * (-1), transform.position.y + .2f+(i/2f), -1);
                    Vector3 ScaleKunai;
                    ScaleKunai = bullet.transform.localScale;
                    ScaleKunai.x *= -1;
                    bullet.transform.localScale = ScaleKunai;
